...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.stockapp.aitoolsservice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.stockapp.aitoolsservice.security.DomainUserDetailsService", "createSpringSecurityUser");
